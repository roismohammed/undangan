	...
	return (
		<div>
			...
			<div className="bg-slate-50 h-screen w-full">
				<div className="flex p-4 md:p-16 gap-6">
					<div className="w-full md:w-8/12">
						...
						<div className="flex gap-6 mt-6">
							<div className="w-full md:w-7/12">
								<Card
									className="rounded-xl border-pink-200  shadow-none p-10"
									style={{ background: "#FEF3F9" }}
								>
									<CardTitle>
							...
							<div className="w-full md:w-7/12">
								<Card
									className="rounded-xl border border-pink-200  shadow-none p-10"
					...
					<div className="w-4/12">
						<Card
							className="rounded-xl border border-pink-500 p-5 h-[550px] flex flex-col justify-between items-center"
							style={{ borderWidth: "1px", background: "#EB578B" }}
						>
							<CardTitle>
							...
							<Button
								className="rounded-full  bg-pink-100 flex gap-2 hover:bg-pink-200 text-pink-500"
							>
