    ...
    <div>
      ...
      <div className="bg-slate-50 md:h-screen w-full">
        ...
        >
          ...
          <div className="w-full md:w-8/12">
            ...
            >
              <Card
                className="rounded-xl border border-pink-200 shadow-none p-4 md:p-10"
                ...
                <CardContent>
                  <CardTitle>
                    <p
                      ...
                      style={{ color: '#E91C8A', maxWidth: '500px' }}
                    >
                  ...
                  <Button
                    className="rounded-full mt-4 md:mt-24 text-white flex gap-2"
            ...
            <div className="flex flex-col md:flex-row gap-6 mt-6">
              ...
              >
                <Card
                  className="rounded-xl border-pink-200 shadow-none p-4 md:p-10"
                  style={{ background: '#EFC3AF' }}
                >
                  <CardTitle>
                    <div className="flex gap-5">
                      ...
                      <div>
                        <p
                          className="text-xl md:text-3xl  text-zinc-600"
                          style={{ color: '#E91C8A' }}
                        >
                          Edit Sesukamu
                        </p>
          ...
          >
            <Card
              className="rounded-xl border border-pink-300 p-5 h-[550px] flex flex-col justify-between items-center"
              style={{ background: '#EFC3AF' }}
            >
              <CardTitle>
      ...
      <div className="md:p-16 p-4 ">
            ...
            <div>
              <Select>
                ...
                <SelectContent>
                  ...
                  <SelectItem value="Undangan Ulang Tahun">Undangan Ulang Tahun</SelectItem>
                  <SelectItem value="Undangan Wisuda">Undangan Wisuda</SelectItem>
                  <SelectItem value="Undangan Khitanan">Undangan Khitanan</SelectItem>
                  <SelectItem value="Undangan Aqiqah">Undangan Aqiqah</SelectItem>
                  <SelectItem value="Undangan Syukuran">Undangan Syukuran</SelectItem>
                  <SelectItem value="Undangan Duka">Undangan Duka</SelectItem>
                </SelectContent>
              </Select>
            </div>
            ...
            <div>
              <Select>
                ...
                <SelectContent>
                  ...
                  <SelectItem value="ungu">Ungu</SelectItem>
                </SelectContent>
              </Select>
            </div>
          </div>
        ...
        <div className=" flex justify-center mt-6">
          <Button className="rounded-full px-8 py-2 mt-3 hover:bg-none text-pink-500 border border-pink-500 hover:bg-slate-50 bg-transparent flex gap-2">
            Lihat lebih banyak
          </Button>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 p-8 md:p-16">
          <div className="flex flex-col h-full">
            <div className="flex-grow border-r-0 md:border-r-2 h-full border-pink-500">
              <p className="text-lg md:text-xl font-semibold text-pink-500">
                Viding
              </p>
              <p className="mt-3 text-sm md:text-base text-zinc-500">
                Viding adalah One Stop Platform Digitalisasi Pernikahan yang
                membuat pernikahan kamu menjadi lebih efisien, efektif,
                bermakna, dan Up to Date.
              </p>
